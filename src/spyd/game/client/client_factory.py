...
class ClientFactory(object):
    def __init__(self, client_number_provider, room_bindings, auth_world_view_factory, permission_resolver):
    ...
    def build_client(self, client_protocol, binding_port):
        ...
        return Client(client_protocol, clientnum, room, auth_world_view, self.permission_resolver)
