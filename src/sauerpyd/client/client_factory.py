...
from server.client_protocol_wrapper import ClientProtocolWrapper

class ClientFactory(object):
    
    def __init__(self, client_number_provider, room_bindings, master_client_bindings):
    ...
    def build_client(self, binding_protocol, connect_message):
        ...
        return Client(identifier, protocol_wrapper, host, port, clientnum, room, master_client)
